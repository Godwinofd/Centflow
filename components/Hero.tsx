    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden bg-black">
      ...
      >
        <div className="inline-block px-5 py-2 border border-primary/50 text-primary text-[10px] uppercase tracking-[0.5em] font-bold mb-10 animate-pulse bg-primary/10 backdrop-blur-md rounded-full shadow-[0_0_20px_rgba(45,71,255,0.4)] font-jura">
          PERFORMANCE MARKETING PROTOCOL
        </div>
        ...
        <p className="text-base md:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto mb-16 font-sf font-light leading-relaxed px-4 sm:px-0">
          We build high-performance growth engines for elite businesses. Precision-engineered digital marketing designed to dominate market share and drive scalable revenue.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
          <button className="group relative px-8 py-4 bg-primary text-white font-bold text-sm rounded-full overflow-hidden transition-all shadow-[0_0_40px_rgba(45,71,255,0.6)] hover:shadow-[0_0_60px_rgba(45,71,255,0.8)] active:scale-95 font-jura uppercase tracking-[0.4em]">
