...
export const IdeaToReality: React.FC = () => {
  ...
  const features = [
    "1+ year in business.",
    "Smart decision-making and advice.",
    "Strategies for you to make the most out of your website."
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-2">
            ...
            <p className="text-gray-400 font-sf text-base md:text-lg font-light leading-relaxed mb-8 md:mb-10 max-w-xl">
              We take the time to get to know you and understand what you want from your website. 
              From there, we'll create a design solution that meets both your needs and your budget, 
              ensuring that it is effective in helping grow your business.
            </p>
            
            <ul className="space-y-4 mb-12">
              {features.map((feature, i) => (
                <li key={i} className="flex items-center gap-4 group">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full border border-primary/40 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
            ...
            <button className="group relative px-10 py-5 bg-primary text-white font-bold text-xs rounded-xl overflow-hidden transition-all shadow-[0_15px_35px_rgba(45,71,255,0.3)] hover:shadow-[0_20px_50px_rgba(45,71,255,0.5)] active:scale-95 font-jura uppercase tracking-[0.2em] flex items-center gap-3">
