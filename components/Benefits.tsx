  ...
  const benefits = [
    {
      ...
      description: "While others wait for organic cycles, our performance architectures generate inbound demand within < 48 hours of activation.",
      icon: (
    ...
    },
    {
      ...
      description: "We deploy algorithmic targeting models based on high-intent search data, behavioral triggers, and granular audience segmentation.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Displace established competitors and claim the highest-converting real estate on SERPs with technical authority and superior systems.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Full architectural transparency. Every conversion is traced back to its origin with mathematical certainty through our proprietary tracking layers.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 md:mb-28 gap-8 md:gap-12">
          ...
          <div className="lg:max-w-xs lg:mb-4">
            <p className="text-gray-500 font-sf text-sm md:text-base font-light leading-relaxed border-l-2 border-primary/20 pl-6">
              We replace guesswork with engineering protocols, delivering unfair market advantages at velocity.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 md:mt-24 p-1 rounded-[2rem] md:rounded-full bg-gradient-to-r from-transparent via-white/10 to-transparent">
          <div className="bg-black rounded-[2rem] md:rounded-full py-6 px-8 md:px-12 flex flex-wrap justify-center items-center gap-8 md:gap-24">
            <div className="flex flex-col items-center min-w-[100px]">
              ...
              <span className="text-[8px] md:text-[9px] font-bold text-gray-500 uppercase tracking-widest">Transparency</span>
            </div>
            <div className="flex flex-col items-center min-w-[100px]">
              <span className="text-2xl md:text-3xl font-bold font-jura text-white tracking-tighter">48H</span>
              <span className="text-[8px] md:text-[9px] font-bold text-gray-500 uppercase tracking-widest">Avg. Deployment</span>
            </div>
            <div className="flex flex-col items-center min-w-[100px]">
              <span className="text-2xl md:text-3xl font-bold font-jura text-white tracking-tighter">3.5X</span>
              <span className="text-[8px] md:text-[9px] font-bold text-gray-500 uppercase tracking-widest">Target ROAS</span>
            </div>
          </div>
        </div>
      </div>
