  ...
  const services = [
    {
      ...
      desc: "A conversion-structured website that turns visitors into enquiries. Built for speed, clarity, and measurable action — not just visual appeal.",
    ...
    },
    {
      ...
      desc: "Organic search presence engineered to attract high-intent prospects month after month. Rankings built on structured content architecture, not short-term tactics.",
    ...
    },
    {
      id: "CF-03",
      title: "Paid Media",
      desc: "Ad campaigns structured around booked enquiries — not impressions. Every pound of spend is tracked against real outcomes: cost per lead, cost per booking.",
    ...
    },
    {
      id: "CF-04",
      title: "AI Automation",
      desc: "Instant lead response and automated follow-up so no enquiry is missed. An AI receptionist handles intake 24/7, removing the manual bottleneck from your growth process.",
    ...
    {
      id: "CF-05",
      title: "Conversion & Growth Scaling",
      desc: "Ongoing optimisation across every channel — tracking what's converting, removing what isn't, and compounding results into predictable revenue growth over time.",
        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 md:mb-16 gap-6 md:gap-8">
            <div className="max-w-3xl">
              ...
              <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold font-anton text-white uppercase leading-[0.9] md:leading-[0.85] tracking-tighter">
                EVERY SYSTEM. <br /><span className="text-primary italic">ONE OUTCOME.</span>
              </h2>
            </div>
            <div className="lg:mb-4">
              <p className="text-gray-500 font-sf text-sm md:text-base font-light max-w-sm leading-relaxed">
                Centflow builds and manages the full digital infrastructure that turns traffic into enquiries. Each capability is designed to work as part of a connected growth system — not a disconnected collection of services.
              </p>
            </div>
          </div>
            ...
            {services.map((service, i) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-base md:text-lg font-bold font-jura mb-6 text-white group-hover:text-primary transition-colors uppercase tracking-tight leading-snug">
                    {service.title}
                  </h3>

                  <p className="text-gray-500 group-hover:text-gray-300 transition-colors font-sf text-sm font-light leading-relaxed">
                    {service.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="mt-16 md:mt-20 text-center">
            <button
              ...
              className="group relative inline-flex items-center gap-4 px-10 py-5 bg-primary text-white font-bold text-xs rounded-full overflow-hidden transition-all shadow-[0_0_40px_rgba(45,71,255,0.3)] hover:shadow-[0_0_60px_rgba(45,71,255,0.6)] active:scale-95 font-jura uppercase tracking-[0.3em]"
            >
              <span className="relative z-10">See How It All Works</span>
