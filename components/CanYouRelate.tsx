  ...
  const painPoints = [
    {
      ...
      text: "Marketing budget is being deployed without clear attribution — making it impossible to know what's generating enquiries and what's quietly wasting spend.",
      icon: (
    ...
    },
    {
      ...
      text: "Enquiries arrive without a system to respond instantly or follow up consistently, meaning high-intent prospects move on before any contact is made.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      text: "Visitors are landing on your website but leaving without taking action — because the page structure, messaging, or speed isn't built to convert.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      text: "Revenue has plateaued not because demand has dried up, but because the backend systems — lead handling, automation, and attribution — aren't built to scale.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 md:mb-32 gap-8 md:gap-12">
          <div className="max-w-4xl">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold font-anton text-white uppercase tracking-tighter leading-[0.9] md:leading-[0.85] mb-0">
              The Gap Is In <br /><span className="text-primary italic">The System.</span>
            </h2>
          </div>
          <div className="lg:max-w-sm">
            <p className="text-gray-500 font-sf text-base md:text-lg font-light leading-relaxed border-l-2 border-primary/20 pl-6 md:pl-8">
              Most enquiry shortfalls aren't caused by a lack of effort — they're caused by gaps in the underlying structure. A website that doesn't convert, a follow-up process that's manual, and marketing spend with no clear attribution quietly compound into stagnating revenue.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 md:mt-24 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-8 md:gap-12 py-8 md:py-8 px-8 md:px-16 border border-white/5 rounded-[2rem] md:rounded-[2.5rem] bg-white/[0.02] backdrop-blur-sm relative overflow-hidden group/cta w-full sm:w-auto">
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <span className="text-[8px] md:text-[10px] font-bold text-primary uppercase tracking-[0.4em] font-jura mb-2">Ready to identify the gap?</span>
              <h4 className="text-lg md:text-xl font-bold font-jura text-white uppercase tracking-tight">Book a Discovery Call</h4>
            </div>
            <button onClick={() => window.open('https://calendar.app.google/nxhNSQ1mE7rXg7Lu7', '_blank')} className="relative w-14 h-14 md:w-16 md:h-16 rounded-full bg-primary text-white flex items-center justify-center transition-all duration-500 hover:scale-110 shadow-[0_0_20px_rgba(45,71,255,0.4)]">
