  ...
  const cases: CaseStudy[] = [
    {
      ...
      task: "Restructure the full digital acquisition system to reduce cost per enquiry and increase booked-call conversion rate within 90 days.",
      strategy: "Deployed conversion-structured landing pages, a revenue-attributed paid media system, AI-powered lead follow-up automation, and full cross-channel attribution tracking — replacing a fragmented setup with a single integrated growth infrastructure.",
      metrics: [
        { label: "CPA Reduction", value: "-65%", color: "#2D47FF", percent: 85 },
        { label: "Conversion Rate", value: "+72%", color: "#2D47FF", percent: 72 },
        { label: "ROAS Improvement", value: "×4.2", color: "#2D47FF", percent: 94 }
      ],
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-24 gap-12">
          <div className="max-w-3xl">
            ...
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold font-anton text-white uppercase tracking-tighter leading-[0.85] mb-4">
              DOCUMENTED <br /><span className="text-primary italic">OUTCOMES.</span>
            </h2>
          </div>
          <div className="lg:mb-4">
            <p className="text-gray-500 font-sf text-xl font-light max-w-sm leading-relaxed border-l border-primary/30 pl-8">
              The following represents a verified performance deployment — from infrastructure design through to measurable revenue impact. Metrics reflect the 90-day period following full system activation.
            </p>
          </div>
        </div>
